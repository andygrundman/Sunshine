...
namespace platf::dxgi {
  ...
  // img_d3d_t (the D3D-backed captured image) is declared in display.h so that other
  // encode paths (e.g. the PyroWave encoder) can open the shared capture texture.
